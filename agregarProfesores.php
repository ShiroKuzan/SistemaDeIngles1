...
<body>
    <header>
      ...
      <td><img src="http://sii.itdelicias.edu.mx/img/sep.gif"> </td>
	  	<td>
					...
					<br>
					<font id="titulo2">Add Professors</font>
      </td>
    ...
    <section class="container">
		<form action="agregarP.php" id="agregarProfesores" method="post">
        <div id="contenido">
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Professor<i class="fa fa-user fa-2x pull-right"></i><br><small>Add a new professor</small>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form action="" class="form-horizontal reducido" method="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="password" name="password" class="form-control" placeholder ="The password would be the same as the rfc" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button id="SaveProfesor" class="btn btn-primary btn-block btn-lg">
