...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['clase']=='c') {
	...
	$sql="select * from alumno where Activo='y'";
                     ...
                     <table class="display" id="TablaAlumnos"><!--table class="table table-striped"-->
                        <thead>
                         ...
                         <tbody>
                                ...
                                <tr>     
                                   <td><a href="modificarA.php?numero=<?php echo $row['NumeroControl'];?>" class="btn btno nolink" role="button"><?php echo $row['NumeroControl'];?></a></td>
