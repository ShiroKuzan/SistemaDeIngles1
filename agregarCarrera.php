                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Career<i class="fa fa-user fa-2x pull-right"></i><br><small>Register a new carrer (dont forget about Ing. or Lic.)</small>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form id="Colocacion" action="" class="form-horizontal reducido" method="post">
                                <div class="form-group">
                                    <label for="numeroControl" class="sr-only">
                                        Name of the new career
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="fa fa-rebel"></i>
                                        </span>
                                        <input type="text" id="nombre" name="nombre" class="form-control" placeholder ="Name of the new career">
                                    </div>
                                </div>
                                <div class="row">
