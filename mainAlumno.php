...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['clase']=='s') {
    ...
    <header>
      ...
      <td><img src="http://sii.itdelicias.edu.mx/img/sep.gif"> </td>
	  	<td>
					...
					<br>
					<font id="titulo2">Student's Menu</font>
      </td>
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse  navbar-collapse" id="bs-activacion">
                   <ul class="nav navbar-nav" >
                        <li>
                            <a href="mostrarCalificaciones.php" role="button" aria-haspopup="true" aria-expanded="false">Show Grades</a>
                        </li>
                        <li>
                            <a href="cambiaContraseñaAlumno.php" role="button" aria-haspopup="true" aria-expanded="false">Change Password</a>
                        </li>
                    </ul>
