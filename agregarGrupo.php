...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true && $_SESSION['clase']=='c') {
	...
	$sql="select * from profesor where Activo='y'";
...
<body>
    ...
    <section class="container">
		<form action="agregarG.php" id="agregarGrupo" method="post">
        <div id="contenido">
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Group<i class="fa fa-user fa-2x pull-right"></i><br><small>Add a new group</small>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form action="" class="form-horizontal reducido" method="post">
                                <div class="form-group">
                                    <label for="idGrupo" class="sr-only">
                                        Group's ID
                                    </label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="idGrupo1" name="idGrupo1" class="form-control" placeholder ="Group's ID">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="nivel" class="sr-only">
                                        English Level
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="text" id="nivel" name="nivel" class="form-control" placeholder ="English Level">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="aula" class="sr-only">
                                        Classroom
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="text" id="aula" name="aula" class="form-control" placeholder ="Classroom">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="rfcs" name="rfcs" style="width: 490px; height: 35px">
								...
								<div class="form-group">
                                    <label for="modalidad" class="sr-only">
                                        Modality
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
										...
										<select id="modalidad" name="modalidad" style="width: 490px; height: 35px">
                                ...
                                <div class="form-group">
                                    <h6>Start of the period</h6>
                                    <label for="inicio" class="sr-only">
                                        Start of the period
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="date" id="inicio" name="inicio" class="form-control" placeholder ="Start of the period">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <h6>End of the period</h6>
                                    <label for="final" class="sr-only">
                                        End of the period
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="date" id="finals" name="finals" class="form-control" placeholder ="End of the period">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button id="SaveGroup" class="btn btn-primary btn-block btn-lg">
