...
<body>
    ...
    <section class="container">
		<label>Professors List</h6></label>&nbsp;&nbsp;
        <br>
                     ...
                     <table class="display" id="TablaAlumnos"><!--table class="table table-striped"-->
                        <thead>
                         ...
                         <tbody>
                                ...
                                <tr>     
                                   <td><a href="modificarP.php?rfc=<?php echo $row['RFC'];?>" class="btn btno nolink" role="button"><?php echo $row['RFC'];?></a></td>
								   <td><a href="modificarP.php?rfc=<?php echo $row['RFC'];?>" class="btn btno nolink" role="button"><?php echo $row['Nombre'];?></a></td>
                                   <td><a class="btn btn-danger btn-sm" href="modificarP.php?rfc=<?php echo $row['RFC']; ?>"><i class="fa fa-close"></i></a></td>
                                </tr>
                                <?php } ?>
                        </tbody>
                     </table>
