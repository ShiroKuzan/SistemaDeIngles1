...
<body>
    <header>
      ...
      <td><img src="http://sii.itdelicias.edu.mx/img/sep.gif"> </td>
	  	<td>
					...
					<br>
					<font id="titulo2">Register Colocation Grades</font>
      </td>
    ...
    <section class="container">
		<form method="post" action="colocacion.php">
        <div id="contenido">
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Student<i class="fa fa-user fa-2x pull-right"></i><br><small>Register level</small>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form id="Colocacion" action="crearHorario.php" class="form-horizontal reducido" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="numeroControl" name="numeroControl" class="form-control" placeholder ="Control Number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nivel" name="nivel" class="form-control" placeholder ="Level Obtained">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-offset-4 col-sm-4">
                                        <button id="colocar" class="btn btn-primary btn-block btn-lg">
